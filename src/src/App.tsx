...
import { DetailedMetricView } from './components/DetailedMetricView'
...
export default function App() {
  ...
  const handleBackFromMetric = useCallback(() => {
    setSelectedMetric(null)
  }, [])
  ...
  // Show detailed metric view if a metric is selected
  if (selectedMetric) {
    return <DetailedMetricView metricType={selectedMetric} onBack={handleBackFromMetric} />
  }
